...
{
public:
	std::string _nom;			//Genere aleatoirement.
	int _genre;					//0: Feminin, 1: Masculin.
	int _pointsVie;				//Points de vie sur 100. A 0, le membre meurt.
	std::string _specialisation;//"", "Che", "Soldat", "Medecin", "Enseignant", "Pilote".
	...
	std::string _objet; //Possede un objet parmis 15 types, +1 pour aucun objet. "", "Mitraillette legere", "Mitraillette", "Carabine", "Fusil a pompe", "Pistolet", "Fusil de precision", "Kit Chirurgical", "Kit de premiers soins", "Kit pharmaceutique", "Livre d'espagnol", "Livre d'economie", "Livre de politique", "Moto", "Auto pick-up", "Camion militaire".
	
	std::string _ePrenomF[10] = {"Ariana", "Catarina", "Cecilia", "Fabiana", "Guadalupe", "Isabel", "Maria", "Paola", "Pilar", "Soledad"};
	std::string _ePrenomM[10] = {"Alejandro", "Alonzo", "Antonio", "Benito", "Diego", "Emmanuel", "Jorge", "Juan", "Leandro", "Rodrigo"};
